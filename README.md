> **Working copy:** this standard is maintained in [aaron-marketing-skills — `references/roas-benchmark.md`](https://github.com/aaron-he-zhu/aaron-marketing-skills/blob/main/references/roas-benchmark.md)
> and published here as its citable home. Framework changes land there first, then sync here (`scripts/sync-family.sh`).

<!-- SYNC:BEGIN source=references/roas-benchmark.md umbrella=v13.0.0 — generated by scripts/sync-family.sh; edit the source, not this block -->
# ROAS Benchmark — Paid Ads Evaluation Standard

The fourth framework in this library, alongside [CORE-EEAT](https://github.com/aaron-he-zhu/aaron-marketing-skills/blob/main/references/core-eeat-benchmark.md) (content quality), [CITE](https://github.com/aaron-he-zhu/aaron-marketing-skills/blob/main/references/cite-domain-rating.md) (domain authority), and [C³](https://github.com/aaron-he-zhu/aaron-marketing-skills/blob/main/references/c3-benchmark.md) (influencer). ROAS scores **paid advertising** — named after the metric paid acquisition exists to maximize (Return On Ad Spend) — across four goal-weighted levers whose initials spell the name.
...
ROAS's letters **R/O/A** overlap C³'s ACE/ART/**ROI (R/O/I)** and the veto IDs R1/R2/O1/O2 textually resemble other frameworks' item IDs — but each framework's IDs are independent (C³'s ROI scope has **no** veto). In any shared document (e.g. [auditor-runbook.md](https://github.com/aaron-he-zhu/aaron-marketing-skills/blob/main/references/auditor-runbook.md) §5) always qualify the letter with the framework name (`ROAS-R` vs `C³ ROI-R` vs `CITE-...`). The runbook lists ROAS vetoes under a Paid-Ads sub-heading.
