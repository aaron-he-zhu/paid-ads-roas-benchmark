...
<!-- SYNC:BEGIN source=references/roas-benchmark.md umbrella=v19.0.0 — generated by scripts/sync-family.sh; edit the source, not this block -->
...
The framework is advisory. Executable items, profiles, context, and vetoes live in [`framework-catalog.json`](framework-catalog.json); common evidence, missingness, score, status, and verdict rules live in [`scoring-semantics.md`](https://github.com/aaron-he-zhu/aaron-marketing-skills/blob/main/references/scoring-semantics.md).
...
Experiment helpers return statistical facts; the calling skill owns the precommitted business decision under [`measurement-protocol.md`](https://github.com/aaron-he-zhu/aaron-marketing-skills/blob/main/references/measurement-protocol.md). ROAS remains advisory until its versioned profiles pass the calibration protocol.
<!-- SYNC:END -->
